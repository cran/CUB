...
#' @aliases ihg00
#' @usage ihg00(m, ordinal, makeplot, summary)
...
ihg00<-function(m,ordinal,makeplot,summary){
  tt0<-proc.time()
  ...
  if (summary==TRUE){
    cat("\n")
    cat("=======================================================================","\n")
    cat(">>>    ML estimation of an IHG model without covariates  <<","\n") 
    cat("=======================================================================","\n")
    ...
    cat("=======================================================================","\n")
    cat("(R=r) Observed IHG-prob","Pearson","Relative res.","\n")
  ...
  if (makeplot==TRUE){
    plot(cbind(1:m,1:m),cbind(theorpr,(freq/n)),
         ...
         ylab="Observed freq. (dots) and fitted prob. (circles)",cex.lab=0.9,cex.main=0.9)
